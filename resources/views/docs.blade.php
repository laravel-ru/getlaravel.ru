                    ...
                    <div class="overflow-y-auto overflow-x-hidden px-4 lg:overflow-hidden lg:px-8 xl:px-16">
                        ...
                        @if ($promote == 'forge')
                            <div :class="{ 'hidden': !navIsOpen }" x-cloak class="mt-4 px-3 py-2 border-dashed border-gray-200 border rounded-lg text-xs leading-loose text-gray-700 lg:block dark:border-gray-400 dark:text-gray-200">
                                <span class="font-medium">Laravel Forge:</span> создание серверов PHP 8 и управление ими. Разверните свои приложения Laravel за секунды. <a class="underline text-red-600" href="https://forge.laravel.com">Зарегистрируйтесь сейчас!</a>.
                            </div>
                        @endif

                        @if ($promote == 'vapor')
                            <div :class="{ 'hidden': !navIsOpen }" x-cloak class="mt-4 px-3 py-2 border-dashed border-gray-200 border rounded-lg text-xs leading-loose text-gray-700 lg:block dark:border-gray-400 dark:text-gray-200">
                                <span class="font-medium">Laravel Vapor:</span> ощутите невероятные масштабы на выделенной бессерверной платформе для Laravel. <a class="underline text-red-600" href="https://vapor.laravel.com">Зарегистрируйтесь сейчас!</a>.
                            </div>
                        @endif

                        @if ($promote == 'spark')
                            <div :class="{ 'hidden': !navIsOpen }" x-cloak class="mt-4 px-3 py-2 border-dashed border-gray-200 border rounded-lg text-xs leading-loose text-gray-700 lg:block dark:border-gray-400 dark:text-gray-200">
                                <span class="font-medium">Laravel Spark:</span> следующее поколение Spark <a class="underline text-red-600" href="https://spark.laravel.com">доступно сейчас</a>.
                            </div>
                        @endif
                    </div>
                ...
                <div class="relative mx-auto w-full py-10 bg-white transition duration-200 dark:bg-dark-700">
                    <div class="mx-auto px-8 sm:px-16 flex items-center justify-between">
                        ...
                        <div class="flex-1 flex items-center justify-end">
                            <button id="header__sun" onclick="toSystemMode()" title="Переключиться на системную тему" class="relative w-10 h-10 focus:outline-none focus:shadow-outline text-gray-500">
                            ...
                            <button id="header__moon" onclick="toLightMode()" title="Переключиться на светлый режим" class="relative w-10 h-10 focus:outline-none focus:shadow-outline text-gray-500">
                            ...
                            <button id="header__indeterminate" onclick="toDarkMode()" title="Переключиться на темный режим" class="relative w-10 h-10 focus:outline-none focus:shadow-outline text-gray-500">
                                <svg style="width:24px;height:24px" viewBox="0 0 24 24">
                ...
                <div class="max-w-screen-lg px-8 sm:px-16 lg:px-24">
                    <div class="flex flex-col items-end border-b border-gray-200 py-1 transition-colors dark:border-gray-700 lg:mt-8 lg:flex-row-reverse">
                        ...
                        <div class="w-full lg:w-40 lg:pl-12">
                            <div>
                                <label class="text-gray-600 text-xs tracking-widest uppercase dark:text-gray-500" for="version-switcher">Версия</label>
